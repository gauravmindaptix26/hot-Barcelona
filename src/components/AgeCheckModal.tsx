    ...
    <div className="fixed inset-0 z-[200] overflow-y-auto bg-black/75 p-3 backdrop-blur-sm sm:p-4">
      <div className="flex min-h-full items-start justify-center py-2 sm:items-center sm:py-8">
        <div
          ...
          className="w-full max-w-md rounded-3xl border border-white/15 bg-[#0b0c10] p-5 text-white shadow-[0_24px_60px_rgba(0,0,0,0.55)] max-h-[calc(100svh-1rem)] overflow-y-auto sm:max-h-[calc(100svh-2rem)] sm:p-8"
        >
          ...
          <div className="sticky bottom-0 mt-5 -mx-5 border-t border-white/10 bg-[#0b0c10]/95 px-5 pb-[calc(env(safe-area-inset-bottom)+0.25rem)] pt-4 backdrop-blur sm:static sm:m-0 sm:border-0 sm:bg-transparent sm:px-0 sm:pb-0 sm:pt-0">
            <button
              type="button"
              onClick={handleConfirm}
              className="w-full rounded-full bg-gradient-to-r from-[#f5d68c] via-[#f5b35c] to-[#d46a7a] px-6 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-black shadow-[0_16px_32px_rgba(245,179,92,0.35)] transition hover:brightness-110"
            >
              I am 18+
            </button>
          </div>
