      ...
      {selectedProfile && (
        ...
        >
          ...
          <motion.div
              ...
              className="relative z-10 mx-auto w-full max-w-6xl rounded-[32px] border border-white/10 bg-[#0b0c10]/95 shadow-[0_40px_90px_rgba(0,0,0,0.55)]"
            >
            ...
            <div className="px-6 py-10 sm:px-8 sm:py-10 lg:px-8 lg:py-10">
              ...
              />
                ...
                <section
                  id="profile-map-section"
                  className="rounded-[28px] border border-white/10 bg-[linear-gradient(160deg,rgba(255,255,255,0.06),rgba(10,11,13,0.94)_45%)] p-6 sm:p-7"
                >
                ...
                <section
                  id="profile-details-section"
                  className="rounded-[28px] border border-[#f5d68c]/25 bg-[linear-gradient(145deg,rgba(245,214,140,0.15),rgba(245,179,92,0.03)_22%,rgba(10,11,13,0.96)_52%)] p-6 sm:p-7"
                >
                ...
                <section
                  ...
                  className="rounded-[28px] border border-[#f5d68c]/25 bg-[linear-gradient(145deg,rgba(245,214,140,0.09),rgba(10,11,13,0.78)_40%,rgba(10,11,13,0.95))] p-6 sm:p-7"
                >
                  <p className="text-xs uppercase tracking-[0.45em] text-[#f5d68c]">
                    About
                  </p>
